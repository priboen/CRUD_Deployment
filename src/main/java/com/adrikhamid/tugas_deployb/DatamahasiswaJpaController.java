...
import com.adrikhamid.tugas_deployb.exceptions.NonexistentEntityException;
import com.adrikhamid.tugas_deployb.exceptions.PreexistingEntityException;
...
public class DatamahasiswaJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("com.adrikhamid_tugas_deployb_jar_0.0.1-SNAPSHOTPU");
